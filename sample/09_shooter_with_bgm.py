...
class App:
    def __init__(self):
        ...
        pyxel.sound(4).set("a3a2c1a1", "p", "7", "s", 5)
        pyxel.sound(5).set("a3a2c2c2", "n", "7742", "s", 10)
        with open(f"./assets/bgm_title.json", "rt") as fin:
            self.bgm_title = json.loads(fin.read())
        with open(f"./assets/bgm_play.json", "rt") as fin:
            self.bgm_play = json.loads(fin.read())
